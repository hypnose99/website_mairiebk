...
export interface ApiEvenementEvenement extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categorie: Schema.Attribute.Enumeration<
      ['culturel', 'sportif', 'politique', 'social']
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dateDebut: Schema.Attribute.DateTime;
    dateFin: Schema.Attribute.Date;
    description: Schema.Attribute.Text;
    featured: Schema.Attribute.Boolean;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    lieu: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiFlashInfoFlashInfo extends Struct.CollectionTypeSchema {
  collectionName: 'flash_infos';
  info: {
    displayName: 'FlashInfo';
    pluralName: 'flash-infos';
    singularName: 'flash-info';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::flash-info.flash-info'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    titre: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['info', 'travaux', 'alerte', 'urgent']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProjetProjet extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bailleur: Schema.Attribute.String;
    budget: Schema.Attribute.String;
    categorie: Schema.Attribute.Enumeration<
      ['infrastructure', 'social', 'education', 'sante', 'economie']
    >;
    contenu: Schema.Attribute.RichText;
    coverImageUrl: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    ...
    > &
      Schema.Attribute.Private;
    maitreOuvrage: Schema.Attribute.String;
    progression: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    resume: Schema.Attribute.Text;
    statut: Schema.Attribute.Enumeration<['planifie', 'en-cours', 'termine']>;
    titre: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
